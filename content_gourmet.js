...
- 候補者の経歴を具体的に引用する（社名・店名・業務名を出す）のは「冒頭のアンカー文」と「気になった一点」の2箇所だけ。ブロック6の2つ目の段落とクロージングの1文目では、職種レベルの語（接客・調理など）に軽く触れるだけにとどめる。経歴の全項目を回収しようとしない
...
## ブロック6: 古川の自己紹介（自分に触れるのはここだけ。2つの短い段落に分ける）
...
麺業態フラグが立っている場合はこの段落に1文だけ追加する。候補者の麺業態経験に触れ、同じ麺業態を歩んできた者としての親近感を、押しつけがましくならない範囲で示す。
...
## ブロック7: 選考スピードと募集条件（すかいらーく言及はここに統合する）
