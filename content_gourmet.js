...
レベル濃:
候補者の職務経歴から具体的な業務内容・マネジメント範囲・数値実績を引用し、「あなたのご経歴を拝見したときに、正直、目に留まりました」から始めて、なぜ目に留まったかを具体的に述べる。資さんうどんの成長にとって必要な力だという結び。

レベル中:
「キャリアを伝える」欄の記述や経験業態・経験年数を引用し、同様の構成で書く。読み取れない実績を推測で補わない。
...
ここまでのご経験を、次はどのようなステージで活かしていきたいのか。
そして、資さんうどんが急速な拡大フェーズの中で、どんな役割を期待しているのか。
そういったことを、ぜひ一度、直接お話しできればと思っています。

（候補者評価で触れた経験内容に合わせて1文目は自然に調整する）

## 行動喚起

もし少しでもご関心をお持ちいただけましたら、
「話を聞いてみたい」「面接希望」という一言でいいので、
返信をいただけると嬉しいです。

## すかいらーくグループ言及（この位置に一文のみ）

なお、資さんは2024年からすかいらーくグループの一員となっており、経営基盤の面でも安定した環境で挑戦いただけます。
