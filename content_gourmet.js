...
- 改行は文末（。）の直後のみ。内容のまとまりごとに空行1行で段落を分ける
...
経歴の要約・再陳述をしない。本人が知っている経歴を説明し返さない。その経歴の流れの中で引っかかった点・直接聞いてみたいことを、1つだけ選んで書く。問いの形で終えるのが望ましい。
...
直前の段落から空行を入れずに「なお、」で直接続ける。すかいらーくへの言及はこの位置以外でしない。
