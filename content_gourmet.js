...
- 情報が少ない場合: 確認できる事実を1つ使い、1〜2文のつながった文章で正直に書く。細切れの短文に分割しない。無理に褒めたり、個別に熟読したように装ったりしない。
  悪い例（断片的でぶっきらぼう）: 「複数のお店で長年勤務されています。仕事内容までは分かりませんでした。どのような業務を担当されてきたのか、直接お聞きしてみたいです。」
  良い例: 「長く飲食のお仕事を続けてこられた中で、どのような業務を担当されてきたのか。ご登録内容だけでは分からなかったので、直接お聞きしてみたいと思いました。」
